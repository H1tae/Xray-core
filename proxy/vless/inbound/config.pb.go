...
type Fallback struct {
	...
	ShortId       []byte                 `protobuf:"bytes,7,opt,name=short_id,json=shortId,proto3" json:"short_id,omitempty"`
...
func (x *Fallback) GetShortId() []byte {
	if x != nil {
		return x.ShortId
	}
	return nil
...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	"\n" +
	" proxy/vless/inbound/config.proto\x12\x18xray.proxy.vless.inbound\x1a\x1acommon/protocol/user.proto\"\x9d\x01\n" +
	"\bFallback\x12\x12\n" +
	...
	"\x04xver\x18\x06 \x01(\x04R\x04xver\x12\x19\n" +
	"\bshort_id\x18\a \x01(\fR\ashortId\"\x92\x02\n" +
	"\x06Config\x120\n" +
